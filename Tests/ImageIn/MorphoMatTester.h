...
class MorphoMatTester : public Tester {
  public:
    ...
    void init() {
        ...
        addTest(new AlgorithmTest<D>("Erosion d15", new Erosion<D>(d15), "res/M.png", "res/M_erosion_d15.png", nodiff));
        addTest(new AlgorithmTest<D>("Dilatation d15", new Dilatation<D>(d15), "res/M.png", "res/M_dilatation_d15.png", nodiff));
        addTest(new AlgorithmTest<D>("Opening d15", new Opening<D>(d15), "res/M.png", "res/M_opening_d15.png", nodiff));
        addTest(new AlgorithmTest<D>("Closing d15", new Closing<D>(d15), "res/M.png", "res/M_closing_d15.png", nodiff));
        addTest(new AlgorithmTest<D>("Gradient d3", new Gradient<D>(d3), "res/rose.png", "res/rose_gradient_diamond3x3.png", nodiff));
        addTest(new AlgorithmTest<D>("White Top Hat d15", new WhiteTopHat<D>(d15), "res/M.png", "res/M_wtophat_d15.png", nodiff));
        addTest(new AlgorithmTest<D>("Black Top Hat d15", new BlackTopHat<D>(d15), "res/M.png", "res/M_btophat_d15.png", nodiff));
    }
