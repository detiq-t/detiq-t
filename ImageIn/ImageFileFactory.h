...
namespace imagein
{
    ...
    class ImageFileFactory
    {
        public:
             ...
             *
             * Uses the polymorphic method getImageFile(), so this method can handle any file type that your factory can.
             *
             ...
             * You will then need to pass an instance of your own factory to ImageFileAbsFactory::setFactory() so it is used by Image class.
             *
